...
{ 
  ...
  i2c_gpio_init_struct.GPIO_PTx = PTB;
  i2c_gpio_init_struct.GPIO_Dir = DIR_INPUT;
  i2c_gpio_init_struct.GPIO_Pins = GPIO_Pin22|GPIO_Pin23;
  i2c_gpio_init_struct.GPIO_PinControl = INPUT_PULL_UP;
  LPLD_GPIO_Init(i2c_gpio_init_struct);
